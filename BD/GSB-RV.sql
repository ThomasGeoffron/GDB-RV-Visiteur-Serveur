...
/* Nouvelle table Motif */
CREATE TABLE Motif (
  mot_id varchar(4) NOT NULL DEFAULT '',
  mot_libelle varchar(30),
  mot_precision varchar(100),
  PRIMARY KEY (mot_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO Motif VALUES
	('m101', 'Périodicité', ''),
	('m102', 'Nouveauté', 'TU DESCENDS'),
	('m103', 'Remontage', '');

/* Ajout propriété mot_id */
...
INSERT INTO RapportVisite VALUES
	( 'a131' , 1 , '2018-03-01' , 'RAS' , 4 , '2018-03-02' , 22, 'm103' ) ,
	( 'a131' , 2 , '2018-04-02' , 'RAS' , 5 , '2018-04-02' , 22, 'm103' ) ,
	( 'a131' , 3 , '2018-04-03' , 'RAS' , 0 , '2018-04-07' , 18, 'm102' ) ,
	( 'a131' , 4 , '2018-05-10' , 'RAS' , 3 , '2018-05-11' , 22, 'm101' ) ,
	( 'a131' , 5 , '2018-05-21' , 'RAS' , 2 , '2018-05-25' , 18, 'm101' ) ;
...
CREATE TABLE Visiteur (
  ...
  vis_mdp varchar(20) NOT NULL DEFAULT '',
  sec_code varchar(2) DEFAULT NULL,
